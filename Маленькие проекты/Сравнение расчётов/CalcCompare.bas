...
Const firstTab = "1С"   'Первая таблица
Const secondTab = "Вода"     'Вторая таблица
Const resultTab = "ВодаR"  'Таблица с результатом
...
Sub PrepareTabFromAccess(shit As String)
    ...
    For i = 2 To max
        ...
        Cells(i, 1) = Replace(Cells(i, 1), "договор С №  ", "")
        Cells(i, 1) = Replace(Cells(i, 1), "договор С № ", "")
    ...
    For i = 2 To maxOld
        ...
        If Find Then
            ...
            If Abs(rz) > 0 Then
                ...
                Sheets(resultTab).Cells(j, fCom) = "Разница до 5-и рублей"
            End If
            If Abs(rz) > 5 Then
                ...
                changed = changed + 1
                Sheets(resultTab).Cells(j, fCom) = "Не совпал"
            End If
